...
import { Edit, FileWarning, Pencil, Printer, Save, User, LucideIcon as LucideIcon_2 } from "lucide-react";
...
export default function RecruitProfilePage() {
    ...
    const { data: profileResponse, isLoading } = RecruitDataHooks.useProfile();
    ...
    const experiences = (profile?.experiences ?? []) as TRecruitExperience_3[];
  ...
  return (
    <main className="min-h-full">
      ...
      <RecruitSectionShell
                    title="My Profile"
                    description="View and manage your Job Applicant registration profile."
                    icon={User}
                    actions={
                      hasProfile ? (
                        <div className="flex flex-wrap gap-2">
                          ...
                          <Button asChild size="sm" variant="outline">
                            <Link
                              href="/recruit/registration?edit=true"
                              className="flex items-center gap-1.5"
                            >
                  ...
                  >
                    <RecruitProfileGate isLoading={isLoading} hasProfile={hasProfile}>
                      {profile && (
