...
type TCreateInternshipInput = z_2.input<typeof ZCreateInternship>;
...
interface InstructorBasicInfo_3 {
      id: string;
      userId?: string;
      fullName?: string;
      name?: string;
...
export default function NewInternshipPage() {
    ...
    const instructors = React_3.useMemo(() => {
            ...
            const all = Array.isArray(instructorsResp.data) ? instructorsResp.data : [];
                return all.filter((inst: InstructorBasicInfo_3) => inst.isApproved);
          }, [instructorsResp]);
    const form = useForm<TCreateInternshipInput>({
            resolver: zodResolver(ZCreateInternship),
            defaultValues: {
              title: "",
              companyName: "",
              description: "",
              ...
              stipendAmount: null as unknown as number | null,
              onboardingDetails: "",
              lastDate: null,
              startDate: null,
              instructorId: "",
    ...
    const { mutate: createInternship, isPending } =
            SuperAdminDataHooks.useCreateInternship({
              onSuccess: () => {
                router.back();
                setShowDialog(false);
                form.reset();
  ...
  return (<ResponsiveDialog
            ...
            title="Super Admin: Create Running Internship"
            description="Register and post a new running internship with complete cohort metadata and mentor assignment."
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          >
                            <FormControl>
                              <SelectTrigger>
                                <SelectValue_19 placeholder="Select Mode" />
                              </SelectTrigger>
                            </FormControl>
                            <SelectContent>
                        ...
                        >
                          ...
                          <SelectContent>
                            {instructors.length > 0 ? (
                              instructors.map((inst: InstructorBasicInfo_3) => (
                                <SelectItem
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          >
                            <FormControl>
                              <SelectTrigger>
                                <SelectValue_19 placeholder="Select Category" />
                              </SelectTrigger>
                            </FormControl>
                            <SelectContent>
                      ...
                      render={({ field }) => (
                        ...
                        >
                          ...
                          >
                            <FormControl>
                              <SelectTrigger>
                                <SelectValue_19 placeholder="Select Type" />
                              </SelectTrigger>
                            </FormControl>
                            <SelectContent>
