...
const createImmersionSchema = z_2.object({
...
const AddForm_8: React_3.FC = () => {
  ...
  const form = useForm({
    resolver: zodResolver(createImmersionSchema),
    defaultValues: {
      title: "",
      description: "",
      startDate: new Date(),
  ...
  const { mutate: createImmersion, isPending } =
    SuperAdminDataHooks.useCreateImmersion({
      onSuccess: () => {
        router.back();
        router.refresh();
        setShowDialog(false);
  ...
  return (
    <ResponsiveDialog
      ...
      title="Create Immersion Program"
      description="Fill out the fields to publish this program catalog."
    >
      <Form {...form}>
                  ...
                  >
                    <FormControl>
                      <SelectTrigger className="bg-background w-full text-left">
                        <SelectValue_16 placeholder="Select Category..." />
                      </SelectTrigger>
                    </FormControl>
                    <SelectContent>
            ...
            render={({ field }) => (
              <FormItem className="flex flex-col space-y-1">
                ...
                >
                  <FormControl>
                    <SelectTrigger className="bg-background w-full text-left">
                      <SelectValue_16 placeholder="Select Instructor (Optional)..." />
                    </SelectTrigger>
                  </FormControl>
                  <SelectContent>
...
const AddForm_9 = AddForm_8;

const NewImmersionPage: React_2.FC = () => {
  return <AddForm_9 />;
};

export default NewImmersionPage;
