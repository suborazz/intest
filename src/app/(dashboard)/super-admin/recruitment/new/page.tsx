...
import { Bold, Code, FileText, Italic, Link as LinkIcon, List, ListOrdered, Minus, Quote, Redo2, RemoveFormatting, Undo2, Upload, X } from "lucide-react";
...
const createJobOpportunitySchema = z_2.object({
...
type TCreateJob = z_2.infer<typeof createJobOpportunitySchema>;
...
const AddForm_10: React_3.FC = () => {
  ...
  const form = useForm<TCreateJob>({
    resolver: zodResolver(createJobOpportunitySchema),
    defaultValues: {
      companyName: "",
      address: "",
      postOpportunity: "",
  ...
  const { mutate: createJob, isPending } =
    SuperAdminDataHooks.useCreateJobOpportunity({
      onSuccess: () => {
        router.back();
        setShowDialog(false);
        form.reset();
  ...
  const onSubmit = (values: TCreateJob) => {
  ...
  return (
    <ResponsiveDialog
      ...
      description="Fill in the details to publish a new job opportunity."
              ...
              <div className="flex items-center gap-3">
                ...
                {logoFile && (
                  <div className="flex items-center gap-1 rounded bg-emerald-50 px-2 py-1 text-[11px] font-medium text-emerald-600">
                    <span>{logoFile.name.substring(0, 15)}...</span>
              ...
              <div className="flex items-center gap-3">
                ...
                {jdFile && (
                  <div className="flex items-center gap-1 rounded bg-indigo-50 px-2 py-1 text-[11px] font-medium text-indigo-600">
                    <span>{jdFile.name.substring(0, 15)}...</span>
