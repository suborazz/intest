...
import { axiosInstance as axiosInstance_2 } from "@/x/acfb3dca";
...
export default function IDCardPage({ params }: PageProps) {
    ...
    const PrintableIDCard: React_2.FC<PrintableIDCardProps> = ({
      card,
      dateStr,
      initials,
    }) => {
      return (
        <div
          className="relative flex h-[265px] w-[420px] select-none flex-col overflow-hidden rounded-3xl border border-zinc-200 bg-white font-sans text-zinc-900 shadow-md"
          style={{ boxSizing: "border-box" }}
        >
          {}
          <div className="absolute -left-[2px] -right-[2px] -top-[2px] z-0 h-[128px] overflow-hidden">
            <svg
              viewBox="0 0 420 128"
              fill="none"
            ...
            >
              <path
                d="M 0 0 L 420 0 L 420 115 C 320 130, 200 70, 0 110 Z"
                fill="url(#greenGradientPrint)"
              />
              <defs>
                <linearGradient
                  id="greenGradientPrint"
                  x1="0"
                  y1="0"
                  x2="420"
                  y2="128"
          ...
          <div className="absolute inset-0 z-0 opacity-[0.04]">
            ...
            >
              <path
                d="M-20 170 C60 200, 140 150, 220 180 C300 210, 380 160, 460 190"
                stroke="currentColor"
                strokeWidth="1"
              />
              <path
                d="M-20 180 C60 210, 140 160, 220 190 C300 220, 380 170, 460 200"
                stroke="currentColor"
                strokeWidth="1"
              />
              <path
                d="M-20 190 C60 220, 140 170, 220 200 C300 230, 380 180, 460 210"
                stroke="currentColor"
                strokeWidth="1"
              />
            </svg>
          ...
          {}
          <div className="absolute left-[24px] top-[14px] z-10 flex items-center gap-1.5 text-white">
            <div className="flex flex-col text-left">
              <span className="text-[9px] font-black leading-none tracking-wider">
                IIINTERNSHIP
              </span>
              <span className="mt-0.5 text-[6px] uppercase leading-none tracking-wide opacity-80">
                LEARNING NETWORK
              </span>
            </div>
          </div>
          ...
          {}
          <div className="absolute left-[150px] top-[20px] z-10 flex flex-col justify-start text-left font-serif">
            <h2 className="text-[20px] font-black uppercase leading-none tracking-wider text-white">
              INTERN
            </h2>
            <h2 className="mt-0.5 text-[20px] font-black uppercase leading-none tracking-wider text-white">
              ID CARD
            </h2>
          </div>

          {}
          <div className="absolute left-[24px] top-[52px] z-10 flex size-24 items-center justify-center overflow-hidden rounded-full border-[5px] border-emerald-500 bg-white">
            <div className="text-2xl font-bold tracking-tighter text-zinc-600">
              {initials}
            </div>
          </div>
          <div className="absolute left-[96px] top-[124px] z-20 flex size-5 items-center justify-center rounded-full border border-white bg-emerald-500">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
          ...
          {}
          <div className="size-18 absolute bottom-[24px] left-[32px] z-10 flex items-center justify-center overflow-hidden rounded-xl border border-zinc-200 bg-white p-1">
            <img
              src={`https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=${encodeURIComponent(card.cardNo)}`}
              alt="QR Code"
          ...
          {}
          <div className="absolute bottom-[28px] left-[145px] right-[20px] z-10 space-y-1.5 text-left text-[11.5px]">
            <div className="flex items-start">
              <span className="w-14 font-extrabold text-emerald-800">Name</span>
            ...
            <div className="flex items-start">
              <span className="w-14 font-extrabold text-emerald-800">Email</span>
              <span className="mx-1 text-zinc-400">:</span>
              <span className="flex-1 truncate font-semibold text-zinc-900">
                {card.studentEmail}
              </span>
            ...
            <div className="flex items-start">
              <span className="w-14 font-extrabold text-emerald-800">Track</span>
              <span className="mx-1 text-zinc-400">:</span>
              <span className="line-clamp-2 flex-1 font-semibold leading-tight text-zinc-800">
                {card.internshipTitle}
              </span>
            </div>
            <div className="flex items-start">
              <span className="w-14 font-extrabold text-emerald-800">ID</span>
              <span className="mx-1 text-zinc-400">:</span>
              <span className="flex-1 font-mono font-semibold text-zinc-900">
                {card.cardNo}
              </span>
            </div>
            <div className="flex items-start">
              <span className="w-14 font-extrabold text-emerald-800">Issued</span>
              <span className="mx-1 text-zinc-400">:</span>
              <span className="flex-1 font-semibold text-zinc-800">{dateStr}</span>
            </div>
          </div>

          {}
          <div className="absolute bottom-0 left-0 right-0 z-10 h-3.5 bg-gradient-to-r from-[#10b981] to-[#022c22]" />
        </div>
      );
    };
  ...
  const { data, isLoading, isError } =
    StudentDataHook.useEnrollmentIDCard(enrollmentId);
  const card: EnrollmentIDCard_2 | undefined = data?.data;
  ...
  const handleDownload = () => {
    ...
    const idCardHtml = renderToStaticMarkup(
      <PrintableIDCard
        card={{
          ...
          internshipTitle: card.internshipTitle,
        }}
        dateStr={dateStr}
        initials={getInitials(card.studentName)}
      />,
    );
    ...
    printWindow.document.write(`
      <html>
        <head>
          <title>ID Card - ${card?.cardNo || enrollmentId}</title>
  ...
  return (
    <div className="mx-auto flex min-h-[70vh] max-w-lg flex-col items-center justify-center p-4">
      {isLoading ? (
        ...
        <div className="w-full space-y-6">
          <div className="space-y-1.5 text-center">
            <h1 className="text-foreground flex items-center justify-center gap-2 text-2xl font-extrabold tracking-tight">
              <IdCard className="text-primary size-6" /> Digital ID Card
            </h1>
            <p className="text-muted-foreground text-sm">
              Your official digital ID card for the internship program.
            </p>
          </div>

          <div
            id={`id-card-${enrollmentId}`}
            className="relative flex h-[265px] w-full select-none flex-col overflow-hidden rounded-3xl border border-zinc-200 bg-white font-sans text-zinc-900 shadow-md dark:border-zinc-800 dark:bg-zinc-950 dark:text-zinc-100"
          >
            {}
            <div className="pointer-events-none absolute -left-[2px] -right-[2px] -top-[2px] z-0 h-[128px] overflow-hidden">
              <svg
                viewBox="0 0 420 128"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="pointer-events-none absolute inset-0 z-0 opacity-[0.04] dark:opacity-[0.02]">
              ...
              >
                ...
                />
                <path
                  d="M-20 200 C60 230, 140 180, 220 210 C300 240, 380 190, 460 220"
                  stroke="currentColor"
                  strokeWidth="1"
                />
                <path
                  d="M-20 210 C60 240, 140 190, 220 220 C300 250, 380 200, 460 230"
                  stroke="currentColor"
                  strokeWidth="1"
                />
              </svg>
            ...
            {}
            <div className="absolute left-[24px] top-[14px] z-10 flex items-center gap-1.5 text-white">
              <BookOpen className="size-4.5 text-emerald-100" />
              <div className="flex flex-col text-left">
                <span className="text-[9px] font-black leading-none tracking-wider">
                  IIINTERNSHIP
                </span>
            ...
            {}
            <div className="absolute left-[24px] top-[52px] z-10 size-24 overflow-hidden rounded-full border-[5px] border-emerald-500 bg-white">
              <img
                src={`https://api.dicebear.com/7.x/initials/svg?seed=${encodeURIComponent(card.studentName)}&backgroundColor=f4f4f5&textColor=3f3f46`}
                alt="Profile avatar"
                className="h-full w-full object-cover"
              />
            </div>
            <div className="absolute left-[96px] top-[124px] z-20 flex size-5 items-center justify-center rounded-full border border-white bg-emerald-500 dark:border-zinc-950">
            ...
            <div className="absolute bottom-[28px] left-[145px] right-[20px] z-10 space-y-1.5 text-left text-[11.5px]">
              <div className="flex items-start">
                <span className="w-14 font-extrabold text-emerald-800 dark:text-emerald-400">
                  Name
                </span>
                <span className="mx-1 text-zinc-400 dark:text-zinc-600">:</span>
                <span className="flex-1 truncate font-semibold text-zinc-900 dark:text-zinc-100">
                  {card.studentName}
                </span>
              </div>
              <div className="flex items-start">
                ...
                <span className="mx-1 text-zinc-400 dark:text-zinc-600">:</span>
                <span
                  className="flex-1 truncate font-semibold text-zinc-900 dark:text-zinc-100"
              ...
              <div className="flex items-start">
                ...
                <span className="mx-1 text-zinc-400 dark:text-zinc-600">:</span>
                <span
                  className="line-clamp-2 flex-1 font-semibold leading-tight text-zinc-800 dark:text-zinc-200"
              ...
              <div className="flex items-start">
                ...
                <span className="mx-1 text-zinc-400 dark:text-zinc-600">:</span>
                <span className="flex-1 font-mono font-semibold text-zinc-900 dark:text-zinc-100">
                  {card.cardNo}
                </span>
              </div>
              <div className="flex items-start">
        ...
        <div className="py-16 text-center">
          <p className="text-muted-foreground text-sm">ID Card not found.</p>
        </div>
      )}
    </div>
  );
