...
export default function SupportPage() {
    ...
    function TicketStatusBadge_2({ status }: { status: TicketStatus }) {
    ...
    const { mutate: createTicket, isPending: isSubmitting } =
            StudentDataHook.useCreateSupportTicket({
              onSuccess: () => {
                reactForm.reset();
    ...
    const { data: ticketsData, isLoading: isLoadingTickets } =
            StudentDataHook.useMySupportTickets();
    ...
    <div className="space-y-6">
      <PageHeaderLayout>
        <Heading
          ...
          description="Get help and support for your internship journey. Our team is here to assist you."
        />
      </PageHeaderLayout>
                              ...
                              >
                                <div className="min-w-0 flex-1 space-y-1.5">
                                  <div className="flex flex-wrap items-center gap-2.5">
                                    ...
                                    <TicketStatusBadge_2 status={ticket.status} />
                                    <span
