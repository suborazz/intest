...
function CategoryBadge_2({ category }: { category: string }) {
...
export default function NotificationsPage() {
    ...
    function NotificationsList_4() {
      const { data, isLoading, isError, refetch } = StudentDataHook.useNotices();
              ...
              <div className="flex items-start justify-between gap-4">
                <div className="space-y-2">
                  <div className="flex flex-wrap items-center gap-2.5">
                    ...
                    <CategoryBadge_2 category={notice.category || "General"} />
                  </div>
