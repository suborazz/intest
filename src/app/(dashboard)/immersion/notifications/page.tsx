...
import { Bell, Calendar, Download, FileDown, Info, Megaphone, User } from "lucide-react";
...
export default function ImmersionNotificationsPage() {
    ...
    function NotificationsList_3() {
      const { data, isLoading, isError, refetch } = EmersionDataHooks.useNotices();
          ...
          <div className="flex flex-col items-center justify-center space-y-4 py-16 text-center">
            ...
            <div className="space-y-1">
              ...
              <p className="text-muted-foreground max-w-sm text-sm">
                Something went wrong while retrieving announcements.
              </p>
            </div>
        ...
        return (
          <div className="flex flex-col items-center justify-center space-y-4 py-20 text-center">
            ...
            <div className="space-y-1">
              ...
              <p className="text-muted-foreground max-w-sm text-sm">
                You&apos;re all caught up! Notifications about your announcements
                and guidelines will appear here.
              </p>
            </div>
          </div>
        );
      ...
      return (
        <div className="space-y-4">
          {notices.map((notice) => (
            <div
              key={notice.id}
              className="bg-card/60 border-border/40 relative space-y-4 overflow-hidden rounded-2xl border p-5 shadow-[0_8px_32px_0_rgba(0,0,0,0.06)] backdrop-blur-md transition-all duration-200 hover:translate-y-[-1px] hover:shadow-md dark:shadow-[0_8px_32px_0_rgba(0,0,0,0.37)]"
            >
              ...
              <div className="flex items-start justify-between gap-4">
                <div className="space-y-2">
                  <div className="flex flex-wrap items-center gap-2.5">
                    <span className="text-muted-foreground bg-muted rounded px-2 py-0.5 font-mono text-[10px]">
                      {notice.noticeNumber ||
                        `NOT-${notice.id.slice(0, 6).toUpperCase()}`}
                    </span>
                ...
                <div className="bg-primary/10 text-primary hidden shrink-0 rounded-xl p-2 sm:flex">
              ...
              <div className="border-border/50 text-muted-foreground flex flex-col justify-between gap-3 border-t pt-4 text-xs sm:flex-row sm:items-center">
                <div className="flex flex-wrap items-center gap-4">
                  ...
                  <span className="flex items-center gap-1.5">
                    ...
                    {notice.sender?.name || "Administrator"}
                  </span>
                </div>
                ...
                {notice.pdfUrl && (
                  <Button
                    variant="outline"
                    size="sm"
                    className="border-primary/20 text-primary hover:bg-primary/10 h-8 w-full gap-1.5 font-semibold sm:w-auto"
                    onClick={() =>
                      window.open(notice.pdfUrl || undefined, "_blank")
                    }
                  >
    ...
    <div className="mx-auto max-w-3xl space-y-6 px-4 py-8 sm:px-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1 text-sm">
          Stay updated with your immersion program activity.
        </p>
      </div>
      <NotificationsList_3 />
    </div>
