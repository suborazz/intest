...
export default function ImmersionReviewsPage() {
    ...
    <div className="mx-auto max-w-xl space-y-6 p-4">
      <div className="space-y-1">
        ...
        <p className="text-muted-foreground text-sm">
          Share your immersion program experience and feedback with the
          community.
        </p>
      </div>
              ...
              <div className="grid grid-cols-2 gap-4 text-xs">
                <div>
                  ...
                  <p className="text-foreground mt-0.5 font-semibold">
                    {user?.name || "Immersion Participant"}
                  </p>
                </div>
                <div>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="space-y-2">
                  ...
                  <FormControl>
                    <Input
                      placeholder="e.g. Immersion Participant, Field Trainee"
