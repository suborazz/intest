...
export async function GET(request: NextRequest): Promise<NextResponse> {
  ...
  try {
    ...
    const responsePayload = applications.map((application) => {
      ...
      return {
        ...
        programStartDate: application.immersion?.startDate || null,
        programEndDate: application.immersion?.endDate || null,
        programStatus: application.immersion?.status || "ACTIVE",
      };
    });
