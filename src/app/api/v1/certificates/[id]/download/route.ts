  ...
  try {
    ...
    if (!certificate) {
      return errorResponse("NOT_FOUND", "Certificate not found.", {
        ...
        if (userRole !== "SUPER_ADMIN" && certificate.studentId !== userId) {
    ...
    const pdfPayload = {
      ...
      internshipId: certificate.internship.id,
      companyName: certificate.internship.companyName || undefined,
      location: certificate.internship.location || undefined,
      mode: certificate.internship.mode || undefined,
      duration: certificate.internship.duration || undefined,
