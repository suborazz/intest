...
export async function PATCH(
  ...
  try {
    ...
    if (immersion.instructorApprovalStatus === "APPROVED") {
      return successResponse(immersion, {
        message: `Immersion program "${immersion.title}" is already accepted.`,
      });
    }
    ...
    return successResponse(updated, {
      message: `Immersion program "${immersion.title}" accepted successfully.`,
    });
  } catch (error) {
