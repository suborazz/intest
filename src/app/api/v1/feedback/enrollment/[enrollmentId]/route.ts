...
export async function GET(
  ...
  try {
    ...
    if (!enrollment) {
      ...
      const isStudentOwner = enrollment.userId === userId;
      const isInstructorOwner = enrollment.internship.instructorId === userId;
      if (!isStudentOwner && !isInstructorOwner) {
        return errorResponse(
          "FORBIDDEN",
          "Access denied to this enrollment feedback.",
