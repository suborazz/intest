...
export default function ViewNoticePage() {
  ...
  return (
    <main className="bg-background min-h-screen pb-24 pt-[120px]">
      <div className="mx-auto max-w-[800px] px-4 sm:px-6 lg:px-8">
        {}
        <div className="mb-10">
          <Link
            href="/notice"
            className="text-muted-foreground/80 hover:text-foreground inline-flex items-center text-sm font-medium transition-colors"
          >
            <svg
        ...
        {}
        <article className="border-border overflow-hidden rounded-xl border bg-white">
          {}
          <div className="border-border/50 border-b p-8 sm:p-10">
            <div className="mb-6 flex flex-wrap items-center gap-3">
              ...
              <span className="text-muted-foreground/60 text-sm">&bull;</span>
              <span className="text-muted-foreground/80 font-mono text-sm">
                {notice.noticeNumber}
              </span>
            </div>

            <h1 className="text-foreground mb-2 text-3xl font-bold leading-tight tracking-tight sm:text-4xl">
              {notice.title}
            </h1>
          </div>
          ...
          <div className="bg-card p-8 sm:p-10">
            <div className="prose prose-emerald text-foreground/80 max-w-none leading-relaxed">
              <p>{notice.description}</p>

              {notice.category === "Schedule" && (
                <div className="mt-8 rounded-lg border border-blue-100 bg-blue-50/50 p-4">
                  <p className="text-sm font-medium text-blue-800">
                    Please ensure you are ready 15 minutes prior to any
                    scheduled interview slots mentioned in the attached
                    documents.
                  </p>
                </div>
              )}
            ...
            {}
            <div className="border-border/50 mt-12 flex flex-col items-center gap-4 border-t pt-8 sm:flex-row">
              {notice.pdfUrl && (
                <a
                  href={notice.pdfUrl}
                  target="_blank"
                  rel="noreferrer"
                  className="bg-primary hover:bg-primary/90 flex w-full items-center justify-center gap-2 rounded-lg px-6 py-3 text-sm font-semibold text-white shadow-sm transition-all hover:shadow sm:w-auto"
                >
                  <svg
                    className="h-5 w-5"
                    fill="none"
              ...
              <button
                ...
                className="text-foreground/80 border-border/80 hover:bg-muted/50 w-full rounded-lg border bg-white px-6 py-3 text-sm font-semibold transition-all sm:w-auto"
              >
                Print Notice
              </button>
            </div>
