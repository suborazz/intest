...
import { Briefcase as Briefcase_2, CheckCircle2, Clock as Clock_2, Key, Layers, LayoutGrid, List, Send, Share2, Terminal, Briefcase, Check, Clock, Filter, GraduationCap, IndianRupee, Search } from "lucide-react";
...
export default function OnCampusInternshipPage() {
                    ...
                    <div className="relative z-10 mx-auto mt-4 grid w-[min(1300px,calc(100%-56px))] grid-cols-1 items-center gap-8 text-center md:mt-8 lg:grid-cols-2 lg:gap-0 lg:text-left">
                      ...
                      <div className="relative z-30 mx-auto w-full max-w-[560px] lg:mx-0">
                        ...
                        <p className="text-primary-foreground/85 mx-auto max-w-[500px] text-[1rem] leading-[1.6] sm:text-[1.1rem] lg:mx-0">
                          Step straight from your college campus into the corporate world.
                          Explore opportunities brought directly to your university.
                        </p>
                      </div>
                      ...
                      <div className="relative mt-[20px] flex justify-center lg:mt-0 lg:translate-y-[20px] lg:justify-end">
                        <img
                          src="/images/hero-oncampus-internship.jpg"
                          onError={(e) => {
                            (e.target as HTMLImageElement).src = "/images/hero-oncampus-internship.jpg";
                          }}
