          ...
          <div className="relative mx-auto grid w-[min(1300px,calc(100%-56px))] grid-cols-1 items-center gap-8 text-center lg:grid-cols-2 lg:gap-0 lg:text-left">
            <div className="relative z-30 mx-auto w-full max-w-[560px] lg:mx-0">
              ...
              <p className="text-primary-foreground/85 mx-auto mt-[12px] max-w-[500px] text-left text-[0.9rem] leading-[1.6] sm:text-[1.1rem] lg:mx-0">
                Explore our partnered educational institutes that strive for
                academic excellence and innovation. Discover their accreditations,
                campuses, and more.
              </p>
            </div>
...
const HeroSection_24 = HeroSection_23;
...
export default function EducationalInstitutesPage() {
  ...
  const { data: institutesRaw = [], isLoading } =
    StudentDataHook.usePublicPartners("educational-institutes");
  const institutes = institutesRaw as unknown as EducationalInstitute[];
        ...
        <section className="relative z-10 mx-auto mt-12 max-w-[1400px] px-4 sm:px-6 md:mt-16 lg:px-8">
          <div className="mb-10 text-center">
            ...
            <p className="text-muted-foreground mx-auto max-w-2xl text-sm font-medium md:text-base">
              We collaborate with top-tier educational institutions to provide
              the best opportunities for students and professionals.
            </p>
          </div>
          ...
          {isLoading ? (
            ...
            <div className="text-muted-foreground py-12 text-center font-semibold">
              No educational partners registered yet.
            </div>
          ) : (
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
              {institutes.map((institute) => (
                <div
                  key={institute.id}
                  className="group flex flex-col overflow-hidden rounded-2xl border border-white/40 bg-white/60 shadow-[0_8px_30px_rgb(0,0,0,0.06)] backdrop-blur-xl transition-all duration-300 hover:shadow-[0_8px_30px_rgb(0,0,0,0.1)]"
                >
                  <div className="relative h-[150px] w-full overflow-hidden bg-transparent p-2 pb-0">
                    ...
                    />
                    <div className="absolute inset-2 bottom-0 rounded-xl bg-gradient-to-t from-black/60 to-transparent"></div>
                    <div className="absolute bottom-2 left-4 right-4 z-10 flex items-end gap-3">
                      <div className="h-12 w-12 shrink-0 overflow-hidden rounded-lg border border-white/20 bg-white p-1 shadow-lg">
                        <img
                          src={institute.logoUrl || "/images/bg-lines.png"}
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-foreground text-sm font-semibold">
                            {institute.naacAccreditation || "N/A"}
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    {institute.website && (
                      <div className="border-border mt-4 border-t pt-4">
                        <a
                          ...
                          target="_blank"
                          rel="noreferrer"
                          className="from-primary hover:from-primary/90 text-primary-foreground inline-flex w-full items-center justify-center rounded-lg bg-gradient-to-r to-emerald-500 px-4 py-2.5 font-semibold shadow-md transition-all duration-300 hover:to-emerald-500/90"
                        >
                          Visit Website
                          <svg
